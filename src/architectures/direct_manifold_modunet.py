...
class DirectManifoldModUNetReconstructor:
    """
    ...
    def reconstruct_manifold(self):
        ...
        mse_x_norm = mean_squared_error(x_orig, recon_x)
        mse_y_norm = mean_squared_error(y_orig, recon_y)
        mse_z_norm = mean_squared_error(z_orig, recon_z)
        ...
        mse_x_denorm = mean_squared_error(x_orig_raw, recon_x_denorm)
        mse_y_denorm = mean_squared_error(y_orig_raw, recon_y_denorm)
        mse_z_denorm = mean_squared_error(z_orig_raw, recon_z_denorm)
